...
import FiltersByCategory from "../components/FilterCategory";
...
export default function Home() {
      ...
      .catch(({ message }) => {
        if (message === "403") {
          refreshToken(admin?.refresh_token)
            ...
            .catch(() => {
              toast.info("Qayta ro'yxatdan o'ting");
              setAdmin(null);
            });
        }
      })
  ...
  const handleDelete = (id) => {
    console.log(id);
    const checker = confirm("Gulni o'chirmoqchimisiz?");
          ...
          {flowers && (
            <form onSubmit={handleFilter}>
              ...
              <div className="mb-10 flex items-center justify-end gap-2">
                ...
                >
                  Qaytarish <SymbolIcon className="ml-2" />
                </Button>
                <Button type="submit" disabled={enableToFilter}>
                  Saralash <ViewGridIcon className="ml-2" />
                </Button>
              </div>
            </form>
          )}
